...
namespace Domotica
{
    ...
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            activate = FindViewById<Button>(Resource.Id.activate);
            slagboomstand = FindViewById<ImageView>(Resource.Id.SLagboomstand);
            ...
            if (buttonChangePinState != null)
            {
                buttonChangePinState.Click += (sender, e) =>
                {
                    ...
                    {
                        if (connector.CheckStarted()) connector.SendMessage("a");  // Send toggle-command to the Arduino
                    }
                };
            }
        ...
        public void UpdateGUI(string result, TextView textview/*, ImageView imageview*/)
        {
            RunOnUiThread(() =>
            {
                if      (result == "OFF") textview.SetTextColor(Color.Red);
                else if (result == " ON") textview.SetTextColor(Color.Green);
                else if (result == "OMHOOG") { textview.SetBackgroundResource(Resource.Drawable.slagboomOMH); }
                else if (result == "OMLAAG") { textview.SetBackgroundResource(Resource.Drawable.slagboomOML); }
                //else if (result == "OMHOOG") { imageview.SetImageResource(Resource.Drawable.slagboomOMH) ; }
                //else if (result == "OMLAAG") { imageview.SetImageResource(Resource.Drawable.slagboomOML); }
