...
#define lowPin       1  // output, always LOW
...
{ 
   ...
   while (ethernetClient.connected()) 
   {
    ...
    Serial.println("cm");
      ...
      // als wij #1 zijn(via app slagboom omlaag)

if(pinState== false)// wij zijn niet #1
{
if(cm <30)
{ 
  myservo.write(90);
...
{     
        ...
        // case 'a': // Report sensor value to the app  
         //   intToCharBuf(sensorValue, buf, 4);                // convert to charbuffer
          ...
          //  break;
         case 'a': // Report switch state to the app
            if (pinState) { Serial.println("Pin state is ON"); }  // always send 4 chars
            else {  Serial.println("Pin state is OFF"); }
            break;
